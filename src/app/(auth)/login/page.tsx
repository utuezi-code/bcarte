      ...
      <div className="hidden lg:flex w-[50%] bg-bg-light flex-col justify-between p-14 overflow-hidden">
        ...
        <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-5">
          <motion.h2 variants={item} className="text-[52px] font-black text-text-primary leading-[1.0] tracking-tight">
            ...
            <span className="text-primary">vérifiée.</span>
          </motion.h2>
        ...
        <div className="w-full max-w-[360px]">
          <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-8">
            ...
            <motion.div variants={item} className="space-y-1">
              <h1 className="text-[28px] font-black text-text-primary tracking-tight">Bon retour.</h1>
              <p className="text-sm text-text-tertiary">Connectez-vous à votre espace</p>
            </motion.div>
            ...
            <motion.form variants={stagger} onSubmit={submit} className="space-y-5">
              ...
              <motion.div variants={item} className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    type={showPw ? 'text' : 'password'} value={password} onChange={e => setPw(e.target.value)} required
                    placeholder="••••••••"
